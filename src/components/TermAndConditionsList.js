...
import TermAndConditionsIcon from './TermAndConditionsIcon'
import shortid from 'shortid';
import {description1, description2, description3, description4} from './TermAndConditionsDescriptions.js';
